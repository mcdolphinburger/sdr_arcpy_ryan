...
# Script arguments
FGDBVersion = arcpy.GetParameterAsText(0)				# New Geodatabase Version
FGDBOutLoc = arcpy.GetParameterAsText(1)				# New Geodatabase Location
FGDBName = arcpy.GetParameterAsText(2)					# New Geodatabase Name
CoordSys = arcpy.GetParameterAsText(3)					# Feature Layer Coordinate System
lyR = arcpy.GetParameter(4)					  			# Create Road Centerlines Yes/No
lyA = arcpy.GetParameter(5)					 			# Create Addresses Yes/No
lyD = arcpy.GetParameter(6)								# Create Driveways Yes/No
lyL = arcpy.GetParameter(7)								# Create Landmarks Yes/No
lyH = arcpy.GetParameter(8)					   			# Create Hydrants Yes/No
lyC = arcpy.GetParameter(9)					    		# Create Cell Towers Yes/No
lyB = arcpy.GetParameter(10)					    	# Create Bridges Yes/No
side = arcpy.GetParameterAsText(11)						# choose Even/Odd fields or Left/Right fields

# LOCAL VARIABLES
# =========================================================================================================================
FDSLoc = FGDBOutLoc + "\\" + FGDBName + ".gdb"
FCOutLoc = FGDBOutLoc + "\\" + FGDBName + ".gdb\\AddressIt"
rcl_nam = "Centerlines"
add_nam = "Addresses"
dwy_nam = "Driveways"
lmk_nam = "Landmarks"
...
# Create FGDB
# -------------------------------------------------------
msg("\n\nCreating File Geodatabase " + FGDBName + ".gdb")
arcpy.CreateFileGDB_management(FGDBOutLoc, FGDBName, FGDBVersion)

# Create Feature Dataset
# -------------------------------------------------------
msg("Creating Feature Dataset \"AddressIt\"")
arcpy.CreateFeatureDataset_management(FDSLoc, "AddressIt", CoordSys)

# Create FeatureClasses
# -------------------------------------------------------
if lyR:
	msg("Creating Road Centerline FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, rcl_nam, "POLYLINE", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
if lyA:
	msg("Creating Address FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, add_nam, "POINT", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
if lyD:
	msg("Creating Driveway FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, dwy_nam, "POLYLINE", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
if lyL:
	msg("Creating Landmark FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, lmk_nam, "POINT", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
if lyH:
	msg("Creating Hydrant FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, hyd_nam, "POINT", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
if lyC:
	msg("Creating Cell Tower FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, tow_nam, "POINT", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
if lyB:
	msg("Creating Bridge FeatureClasses")
	arcpy.CreateFeatureclass_management(FCOutLoc, brg_nam, "POINT", "", "DISABLED", "DISABLED", CoordSys, "", "0", "0", "0")
...
if lyR:
	...
	if side == "Even/Odd":
		...
		arcpy.AddField_management(IL, "ZIP_L", "TEXT", "", "", "10", "ZIP_L", "NULLABLE", "NON_REQUIRED", "")
		arcpy.AddField_management(IL, "ZIP_R", "TEXT", "", "", "10", "ZIP_R", "NULLABLE", "NON_REQUIRED", "")
	...
	arcpy.AddField_management(IL, "E911_COMM_E", "TEXT", "", "", "32", "E911_COMM_E", "NULLABLE", "NON_REQUIRED", "")
	arcpy.AddField_management(IL, "E911_COMM_O", "TEXT", "", "", "32", "E911_COMM_O", "NULLABLE", "NON_REQUIRED", "")
	arcpy.AddField_management(IL, "ESN_E", "SHORT", "", "", "", "ESN_O", "NULLABLE", "NON_REQUIRED", "")
	arcpy.AddField_management(IL, "ESN_O", "SHORT", "", "", "", "ESN_O", "NULLABLE", "NON_REQUIRED", "")
	arcpy.AddField_management(IL, "EXCHANGE_E", "TEXT", "", "", "4", "EXCHANGE_E", "NULLABLE", "NON_REQUIRED", "")
	arcpy.AddField_management(IL, "EXCHANGE_O", "TEXT", "", "", "4", "EXCHANGE_O", "NULLABLE", "NON_REQUIRED", "")
...
if lyA:
	...
	arcpy.AddField_management(IL, "ESN", "LONG", "", "", "", "ESN", "NULLABLE", "NON_REQUIRED", "")
