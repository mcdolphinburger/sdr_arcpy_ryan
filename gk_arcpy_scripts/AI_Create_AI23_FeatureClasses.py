...
lyR = arcpy.GetParameter(2)					  			# Create Road Centerlines Yes/No
lyA = arcpy.GetParameter(3)					 			# Create Addresses Yes/No
lyD = arcpy.GetParameter(4)								# Create Driveways Yes/No
lyL = arcpy.GetParameter(5)								# Create Landmarks Yes/No
lyH = arcpy.GetParameter(6)					   			# Create Hydrants Yes/No
lyC = arcpy.GetParameter(7)					    		# Create Cell Towers Yes/No
lyB = arcpy.GetParameter(8)					    		# Create Bridges Yes/No
